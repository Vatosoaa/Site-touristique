...
export function DestinationsHero() {
  return (
    <section className="relative min-h-[70vh] md:min-h-[70vh] w-full flex items-center pt-24 pb-12 overflow-hidden bg-[#F8FAFC]">
      ...
      <div className="absolute top-0 right-0 w-full h-full md:w-[60%] z-0">
        <img 
          ...
          alt="Destinations à Madagascar" 
          className="w-full h-full object-cover object-center opacity-50 md:opacity-100"
        />
        {/* Soft gradient to blend with left side */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#F8FAFC] via-[#F8FAFC]/60 md:via-[#F8FAFC]/20 to-transparent" />
      </div>
          ...
          >
            ...
            <div className="relative inline-block mb-8 md:mb-10 group">
              ...
              <span className="relative z-10 text-lg sm:text-xl font-bold text-white px-4 md:px-6 py-2 block italic tracking-wide">
                Explorez les merveilles de l'île
              </span>
            </div>

            <p className="text-lg md:text-xl text-slate-700 mb-12 font-bold max-w-lg leading-relaxed">
              Des plages de sable blanc aux forêts tropicales luxuriantes, chaque région de Madagascar offre une aventure unique. Laissez-nous vous guider.
            </p>
          </motion.div>
        </div>
      </div>
